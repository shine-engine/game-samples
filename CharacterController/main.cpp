...
#endif
{
	...
	displayProperties.m_height          = 480;

	displayProperties.m_bEnable3d       = true;
	displayProperties.m_bEnableZ        = true;
	displayProperties.m_bUseSpecular    = true;
	displayProperties.m_bUsePointLights = true;
	displayProperties.m_bUseShadows		= true;
